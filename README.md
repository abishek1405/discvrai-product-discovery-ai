...
The API key has been hidden to comply with GitHub security policies.
To run the project locally, you must provide your own OpenAI API key in the .env file.

Submission Details:
Live Project:
  ---->  https://discvrai-product-discovery-ai.vercel.app/
